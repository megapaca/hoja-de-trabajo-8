...
class WordTypeCounter {
	public static void main(String[] args) throws Exception
	{
		...
		System.out.println("Bienvenido, Escoja la implementacion que desea utilizar:");
        System.out.println("1.SimpleSet 2.RB Tree 3. SplayTres 4. TreeMap 5.Hash Tree:");
		Scanner teclado = new Scanner (System.in);
        while(decision==0){    
			String impl= teclado.next();
                try {
                    implementacion=Integer.parseInt(impl);
                    decision=1;           
